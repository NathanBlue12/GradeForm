...
function App() {
  ...
  QPICalculator();
  return (
    <div class="text-white flex justify-center space-x-4 m-10 bg-slate-900">
      <div className="flex flex-col p-5 bg-[#CF9033] rounded-lg drop-shadow-lg">
        <div className="flex justify-center italic text-lg text-lg font-extrabold">Add Course</div>
        ...
        <button className="bg-blue-500 rounded-lg drop-shadow-lg  hover:bg-blue-600" onClick={handleAddDataClick}>Submit</button>
      </div>

      <div className="bg-[#CF9033] flex flex-col p-5 rounded-lg w-2/3 drop-shadow-lg">
      <div className="flex justify-center italic text-lg font-extrabold">Grades Table</div>
        <div class="space-x-4">
